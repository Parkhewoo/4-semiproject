...
<form action="${pageContext.request.contextPath}/edit" method="post" autocomplete="off" enctype="multipart/form-data">
    ...
    <div class="container w-800">
        ...
        <div class="row">
            <label>내용</label>
            <textarea name="noticeContent" rows="10" class="field w-100">${noticeDto.noticeContent}</textarea>
        </div>
        <div class="row right">
            <button type="submit" class="btn btn-positive">수정하기</button>
            <a class="btn btn-neutral" href="${pageContext.request.contextPath}/list">목록으로</a>
        </div>
    </div>
</form>
